...
FROM_CHAIN="${FROM_CHAIN:-${FROM_CHAIN_ID:-358974494}}"
TO_CHAIN="${TO_CHAIN:-${TO_CHAIN_ID:-1}}"
...
MIN_AMOUNT="${MIN_AMOUNT:-10000000000000000}"
MAX_AMOUNT="${MAX_AMOUNT:-50000000000000000}"
...
payload="$(
  jq -n \
    --arg expiry "$EXPIRY" \
    --arg fromChain "$FROM_CHAIN" \
    --arg toChain "$TO_CHAIN" \
